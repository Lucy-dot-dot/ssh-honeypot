...
/// Handles the date command with common flags and formats
pub fn handle_date_command(cmd: &str) -> String {
    let mut args = cmd.trim_start_matches("date").trim();
    ...
    if print_version {
        return "date (GNU coreutils) 8.32\n\
