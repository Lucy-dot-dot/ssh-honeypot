-- Enriched authentication view with IP intelligence data
-- Merges auth attempts with IPAPI geolocation and AbuseIPDB threat intelligence
...
COMMENT ON VIEW auth_enriched IS 'Enriched authentication attempts with IP geolocation and threat intelligence. AbuseIPDB data takes precedence for overlapping fields like country_code and ISP.';